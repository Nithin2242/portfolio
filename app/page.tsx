...
import TextParticles from './TextParticles'; // The Exploding N Background
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-gray-200 font-sans selection:bg-red-500 selection:text-white relative overflow-hidden perspective-1000">
      ...
      {/* --- BACKGROUND: EXPLODING N --- */}
      <div className="fixed inset-0 z-0 pointer-events-none">
         <TextParticles />
      </div>

      {/* Dark overlay to make text readable over particles */}
      <div className="fixed inset-0 z-0 bg-neutral-950/70 pointer-events-none"></div>

      <div className="relative z-10">
        
        {/* Navigation */}
        <header className="fixed top-0 w-full bg-neutral-950/60 backdrop-blur-md border-b border-red-900/20 z-50">
        ...
        {/* Hero Section - RESTORED FLOATING ANIMATION */}
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            >
              {[
                ...
                <TiltCard 
                  key={index}
                  className="bg-neutral-900/60 p-8 rounded-2xl border border-neutral-800 hover:border-red-600/50 backdrop-blur-sm"
                >
